mergeInto(LibraryManager.library, {
    SocketIOInit: function () {
        ...
        socket.on("updateProof", (proof) => {
            if (
                this.objectNameDic.updateProof &&
                this.methodNameDic.updateProof
            )
                SendMessage(
                    this.objectNameDic.updateProof,
                    this.methodNameDic.updateProof,
        ...
        socket.on("updateAnonymous", (data) => {
            if (
                this.objectNameDic.updateAnonymous &&
                this.methodNameDic.updateAnonymous
            )
                SendMessage(
                    this.objectNameDic.updateAnonymous,
                    this.methodNameDic.updateAnonymous,
        ...
        socket.on("updateSaveData", (data) => {
            if (
                this.objectNameDic.updateSaveData &&
                this.methodNameDic.updateSaveData
            )
                SendMessage(
                    this.objectNameDic.updateSaveData,
                    this.methodNameDic.updateSaveData,
        ...
        socket.on("exception", (exception) => {
            ...
            for (let i = 0; i < this.exceptionArray.length; i++) {
                SendMessage(
                    this.exceptionArray[i].objectName,
                    this.exceptionArray[i].methodName,
                    exception.toString()
                );
            }
        });
        ...
        socket.on("giftData", (data) => {
            SendMessage(
                this.objectNameDic.giftData,
                this.methodNameDic.giftData,
                data.toString()
            );
        });
        ...
        socket.on("playerMove", (data) => {
            ...
            if (this.objectNameDic.playerMove && this.methodNameDic.playerMove)
                SendMessage(
                    this.objectNameDic.playerMove,
                    this.methodNameDic.playerMove,
                    dataString
                );
        });
        ...
        socket.on("spawnCustomer", (data) => {
            ...
            let dataString = JSON.stringify(data).toString();
            if (
                this.objectNameDic.spawnCustomer &&
                this.methodNameDic.spawnCustomer
            )
                SendMessage(
                    this.objectNameDic.spawnCustomer,
                    this.methodNameDic.spawnCustomer,
        ...
        socket.on("updateCustomerPosition", (data) => {
            let dataString = JSON.stringify(data).toString();
            if (
                this.objectNameDic.updateCustomerPosition &&
                this.methodNameDic.updateCustomerPosition
            )
                SendMessage(
                    this.objectNameDic.updateCustomerPosition,
                    this.methodNameDic.updateCustomerPosition,
        ...
        socket.on("updateCustomerWaitTime", (data) => {
            let dataString = JSON.stringify(data).toString();
            if (
                this.objectNameDic.updateCustomerWaitTime &&
                this.methodNameDic.updateCustomerWaitTime
            )
                SendMessage(
                    this.objectNameDic.updateCustomerWaitTime,
                    this.methodNameDic.updateCustomerWaitTime,
        ...
        socket.on("customerReachDestination", (data) => {
            let dataString = JSON.stringify(data).toString();
            if (
                this.objectNameDic.customerReachDestination &&
                this.methodNameDic.customerReachDestination
            )
                SendMessage(
                    this.objectNameDic.customerReachDestination,
                    this.methodNameDic.customerReachDestination,
        ...
        socket.on("customerReturn", (data) => {
            let dataString = JSON.stringify(data).toString();
            if (
                this.objectNameDic.customerReturn &&
                this.methodNameDic.customerReturn
            )
                SendMessage(
                    this.objectNameDic.customerReturn,
                    this.methodNameDic.customerReturn,
        ...
        socket.on("deleteCustomer", (data) => {
            let dataString = JSON.stringify(data).toString();
            if (
                this.objectNameDic.deleteCustomer &&
                this.methodNameDic.deleteCustomer
            )
                SendMessage(
                    this.objectNameDic.deleteCustomer,
                    this.methodNameDic.deleteCustomer,
        ...
        socket.on("serveBeer", (data) => {
            ...
            if (this.objectNameDic.serveBeer && this.methodNameDic.serveBeer)
                SendMessage(
                    this.objectNameDic.serveBeer,
                    this.methodNameDic.serveBeer,
                    dataString
                );
        });
        ...
        socket.on("updateBeer", (data) => {
            ...
            if (this.objectNameDic.updateBeer && this.methodNameDic.updateBeer)
                SendMessage(
                    this.objectNameDic.updateBeer,
                    this.methodNameDic.updateBeer,
                    dataString
                );
        });
        ...
        socket.on("beerCollided", (data) => {
            let dataString = JSON.stringify(data).toString();
            if (
                this.objectNameDic.beerCollided &&
                this.methodNameDic.beerCollided
            )
                SendMessage(
                    this.objectNameDic.beerCollided,
                    this.methodNameDic.beerCollided,
        ...
        socket.on("updateTimer", (data) => {
            if (
                this.objectNameDic.updateTimer &&
                this.methodNameDic.updateTimer
            )
                SendMessage(
                    this.objectNameDic.updateTimer,
                    this.methodNameDic.updateTimer,
        ...
        socket.on("totalPointCallback", (data) => {
            if (
                this.objectNameDic.totalPointCallback &&
                this.methodNameDic.totalPointCallback
            )
                SendMessage(
                    this.objectNameDic.totalPointCallback,
                    this.methodNameDic.totalPointCallback,
        ...
        socket.on("timeUp", (data) => {
            if (this.objectNameDic.timeUp && this.methodNameDic.timeUp)
                SendMessage(
                    this.objectNameDic.timeUp,
                    this.methodNameDic.timeUp,
                    ""
                );
        });
        ...
        socket.on("upgradeTableCallback", (data) => {
            let dataString = JSON.stringify(data).toString();
            if (
                this.objectNameDic.upgradeTableCallback &&
                this.methodNameDic.upgradeTableCallback
            )
                SendMessage(
                    this.objectNameDic.upgradeTableCallback,
                    this.methodNameDic.upgradeTableCallback,
        ...
        socket.on("updateUpgradePrice", (data) => {
            let dataString = JSON.stringify(data).toString();
            if (
                this.objectNameDic.updateUpgradePrice &&
                this.methodNameDic.updateUpgradePrice
            )
                SendMessage(
                    this.objectNameDic.updateUpgradePrice,
                    this.methodNameDic.updateUpgradePrice,
        ...
        socket.on("getEntryCallback", (data) => {
            ...
            if (
                this.objectNameDic.getEntryCallback &&
                this.methodNameDic.getEntryCallback
            )
                SendMessage(
                    this.objectNameDic.getEntryCallback,
                    this.methodNameDic.getEntryCallback,
        ...
        socket.on("getPlayerPubCallback", (data) => {
            if (
                this.objectNameDic.getPlayerPubCallback &&
                this.methodNameDic.getPlayerPubCallback
            ) {
                SendMessage(
                    this.objectNameDic.getPlayerPubCallback,
                    this.methodNameDic.getPlayerPubCallback,
        ...
        socket.on("updateTreasuryCallback", (data) => {
            if (
                this.objectNameDic.updateTreasuryCallback &&
                this.methodNameDic.updateTreasuryCallback
            ) {
                SendMessage(
                    this.objectNameDic.updateTreasuryCallback,
                    this.methodNameDic.updateTreasuryCallback,
        ...
        socket.on("updateInDayTreasuryCallback", (data) => {
            if (
                this.objectNameDic.updateInDayTreasuryCallback &&
                this.methodNameDic.updateInDayTreasuryCallback
            ) {
                SendMessage(
                    this.objectNameDic.updateInDayTreasuryCallback,
                    this.methodNameDic.updateInDayTreasuryCallback,
        ...
        socket.on("claimCallback", (data) => {
            if (
                this.objectNameDic.claimCallback &&
                this.methodNameDic.claimCallback
            ) {
                SendMessage(
                    this.objectNameDic.claimCallback,
                    this.methodNameDic.claimCallback,
        ...
        socket.on("getPointBeforeClaimCallback", (data) => {
            if (
                this.objectNameDic.getPointBeforeClaimCallback &&
                this.methodNameDic.getPointBeforeClaimCallback
            ) {
                SendMessage(
                    this.objectNameDic.getPointBeforeClaimCallback,
                    this.methodNameDic.getPointBeforeClaimCallback,
        ...
        socket.on("getCanUpgradeTableCallback", (data) => {
            if (
                this.objectNameDic.getCanUpgradeTableCallback &&
                this.methodNameDic.getCanUpgradeTableCallback
            ) {
                SendMessage(
                    this.objectNameDic.getCanUpgradeTableCallback,
                    this.methodNameDic.getCanUpgradeTableCallback,
        ...
        socket.on("updateTablePositionCallback", (data) => {
            if (
                this.objectNameDic.updateTablePositionCallback &&
                this.methodNameDic.updateTablePositionCallback
            ) {
                SendMessage(
                    this.objectNameDic.updateTablePositionCallback,
                    this.methodNameDic.updateTablePositionCallback,
        ...
        socket.on("updateSeatPositionsCallback", (data) => {
            if (
                this.objectNameDic.updateSeatPositionsCallback &&
                this.methodNameDic.updateSeatPositionsCallback
            ) {
                SendMessage(
                    this.objectNameDic.updateSeatPositionsCallback,
                    this.methodNameDic.updateSeatPositionsCallback,
        ...
        socket.on("logoutCallback", (data) => {
            if (
                this.objectNameDic.logoutCallback &&
                this.methodNameDic.logoutCallback
            ) {
                SendMessage(
                    this.objectNameDic.logoutCallback,
                    this.methodNameDic.logoutCallback,
